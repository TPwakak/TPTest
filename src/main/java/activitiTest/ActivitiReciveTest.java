...
public class ActivitiReciveTest {
	ProcessEngine processEngine = ProcessEngines.getDefaultProcessEngine();	

	/**部署流程定义（从inputStream）*/	
	@Test
	public void deploymentProcessDefinition_inputStream(){	
		InputStream inputStreamBpmn = this.getClass().getResourceAsStream("/diagrams/接受活动节点.bpmn");	
		InputStream inputStreamPng = this.getClass().getResourceAsStream("/diagrams/接受活动节点.png");	
		Deployment deployment = processEngine.getRepositoryService()//与流程定义和部署对象相关的Service	
				.createDeployment()//创建一个部署对象			
				.name("接收活动任务")//添加部署的名称
				.addInputStream("接受活动节点.bpmn", inputStreamBpmn)
				.addInputStream("接受活动节点.png", inputStreamPng)	
				.deploy();//完成部署		
	...
	public void startProcessInstance(){	
		//流程定义的key		
		String processDefinitionKey = "接受活动节点";	
