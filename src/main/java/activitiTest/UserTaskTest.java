...
public class UserTaskTest {
	...
	public void deploymentProcessDefinition_inputStream2() {
		...
		Deployment deployment = processEngine.getRepositoryService()
				...
				.addInputStream("个人任务.png", inputStreamPng)
				.deploy();
	 ...
	 */	
	@Test	
	public void deploymentProcessDefinition_inputStream23(){	
		// 引擎配置   
		ProcessEngine processEngine = ProcessEngines.getDefaultProcessEngine();
		InputStream inputStreambpmn = this.getClass().getResourceAsStream("/diagrams/个人任务2.bpmn");		
		InputStream inputStreampng = this.getClass().getResourceAsStream("/diagrams/个人任务2.png");		
		//创建一个与流程定义和部署对象相关的Service
		RepositoryService repositoryService = processEngine.getRepositoryService();
		//获取一个部署对象
		DeploymentBuilder deploymentBuilder= repositoryService.createDeployment();
		//添加部署的名称
		deploymentBuilder.name("个人任务2");
 ...
 */
	...
	public void findHistoryPersonTask(){
		//流程实例ID
		String processInstanceId = "152506";
	...
	//设置流程变量，在发布时 在candidats user 设置为： #{userIDs}
	/**启动流程实例*/	
	@Test	
	public void startProcessInstanceGroup22(){		
		//流程定义的key		
		String processDefinitionKey = "组任务";		
